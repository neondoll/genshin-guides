export const VideoSourceIds = {
  ...
  GUIDE_TO_NEUVILLETTE_IN_6_3_AnimeCool: "guide_to_Neuvillette_in_6.3_AnimeCool",
  GUIDE_TO_NEUVILLETTE_IN_6_3_MironMinMax: "guide_to_Neuvillette_in_6.3_MironMinMax",
  ...
  GUIDE_TO_VARKA_IN_6_4_MironMinMax: "guide_to_Varka_in_6.4_MironMinMax",
  ...
  GUIDE_TO_ZIBAI_IN_6_3_MironMinMax: "guide_to_Zibai_in_6.3_MironMinMax",
  HOW_GOOD_IS_RAIDEN_SHOGUN_CONSTELLATIONS: "how_good_is_Raiden_Shogun_constellations",
  TALENT_GAINS_ANEMO: "talent_gains_Anemo",
  TALENT_GAINS_GEO: "talent_gains_Geo",
  TALENT_GAINS_HYDRO: "talent_gains_Hydro",
  TALENT_GAINS_PYRO: "talent_gains_Pyro",
