...
const initialState = videoSourcesAdapter.getInitialState(undefined, {
  ...
  [VideoSourceIds.GUIDE_TO_COLUMBINA_IN_6_3_AnimeCool]: {
    id: VideoSourceIds.GUIDE_TO_COLUMBINA_IN_6_3_AnimeCool,
    author: "Анимекул",
  ...
  [VideoSourceIds.GUIDE_TO_COLUMBINA_IN_6_3_MironMinMax]: {
    id: VideoSourceIds.GUIDE_TO_COLUMBINA_IN_6_3_MironMinMax,
    author: "Miron MinMax",
  ...
  [VideoSourceIds.GUIDE_TO_FLINS_IN_6_0_AnimeCool]: {
    id: VideoSourceIds.GUIDE_TO_FLINS_IN_6_0_AnimeCool,
    author: "Анимекул",
  ...
  [VideoSourceIds.GUIDE_TO_FLINS_IN_6_0_MironMinMax]: {
    id: VideoSourceIds.GUIDE_TO_FLINS_IN_6_0_MironMinMax,
    author: "Miron MinMax",
  ...
  [VideoSourceIds.GUIDE_TO_FLINS_IN_6_0_xPandaChannelx]: {
    id: VideoSourceIds.GUIDE_TO_FLINS_IN_6_0_xPandaChannelx,
  ...
  [VideoSourceIds.GUIDE_TO_FLINS_IN_6_4_AnimeCool]: {
    id: VideoSourceIds.GUIDE_TO_FLINS_IN_6_4_AnimeCool,
    author: "Анимекул",
    title: "Зачем нужен Флинс? | Обновлённый гайд на Кирилла",
    date: "2026-02-27",
    // vkvideo: "",
