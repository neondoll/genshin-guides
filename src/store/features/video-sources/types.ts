export const VideoSourceIds = {
  ...
  GUIDE_TO_KYRYLL_CHUDOMIROVICH_FLINS_IN_6_0_AnimeCool: "guide_to_KyryllChudomirovichFlins_in_6.0_AnimeCool",
  GUIDE_TO_KYRYLL_CHUDOMIROVICH_FLINS_IN_6_0_MironMinMax: "guide_to_KyryllChudomirovichFlins_in_6.0_MironMinMax",
  GUIDE_TO_KYRYLL_CHUDOMIROVICH_FLINS_IN_6_0_xPandaChannelx: "guide_to_KyryllChudomirovichFlins_in_6.0_xPandaChannelx",
  ...
  GUIDE_TO_RAIDEN_SHOGUN_IN_5_0: "guide_to_RaidenShogun_in_5.0",
  ...
  HOW_GOOD_IS_RAIDEN_SHOGUN_CONSTELLATIONS: `how_good_is_RaidenShogun_constellations`,
