...
export default {
  id: CharacterIds.YANFEI,
  recommendedLevel: "80/90",
  roleIds: [CharacterRoleIds.ON_FIELD, CharacterRoleIds.DPS],
  talents: [
    { type: "combat1", priority: "В первую очередь", recommendedLevel: "9 - 10", overallLevel: 1 },
    { type: "combat2", priority: "Во вторую очередь", recommendedLevel: "8 - 9", overallLevel: 1 },
  ...
  weapons: [
    ...
    { id: WeaponIds.FLOWING_PURITY, best: "Лучшее доступное решение", r: 5 },
  ],
