...
export default {
  ...
  weapons: [
    { id: WeaponIds.NIGHTWEAVERS_LOOKING_GLASS, best: "Лучшее решение" },
    { id: WeaponIds.A_THOUSAND_FLOATING_DREAMS },
    { id: WeaponIds.SUNNY_MORNING_SLEEP_IN },
    { id: WeaponIds.STARCALLERS_WATCH },
    { id: WeaponIds.ETHERLIGHT_SPINDLELUTE, best: "Лучшее эвентовое решение" },
    { id: WeaponIds.BLACKMARROW_LANTERN, best: "Лучшее доступное решение" },
