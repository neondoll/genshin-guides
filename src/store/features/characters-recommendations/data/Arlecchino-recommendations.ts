...
export default {
  ...
  weapons: {
    "Гиперкери | Прожарка | Перегрузка": [
      { id: WeaponIds.CRIMSON_MOONS_SEMBLANCE, best: "Лучшее решение", percent: 1.316 },
      ...
      { id: WeaponIds.WHITE_TASSEL, best: "Лучшее доступное решение", percent: 1.000 },
    ...
    "Пар | Таяние": [
      { id: WeaponIds.CRIMSON_MOONS_SEMBLANCE, best: "Лучшее решение", percent: 1.309 },
