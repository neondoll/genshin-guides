  ...
  "inline-flex gap-2 cursor-pointer select-none items-center justify-center overflow-hidden relative rounded-md font-medium disabled:pointer-events-none disabled:opacity-60 transition-[background-color,color] duration-200 focus-visible:outline-1 focus-visible:outline-offset-2",
  {
    ...
    compoundVariants: [
      ...
      },
      {
        variant: "default",
        severity: "secondary",
        className: "bg-surface-100 hover:bg-surface-200 active:bg-surface-300 text-surface-600 hover:text-surface-700 active:text-surface-800 dark:bg-surface-800 dark:hover:bg-surface-700 dark:active:bg-surface-600 dark:text-surface-300 dark:hover:text-surface-200 dark:active:text-surface-100",
      },
      {
        variant: "default",
        severity: "info",
